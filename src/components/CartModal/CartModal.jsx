          ...
          <div className="product-cart__container">
            ...
            <ul className="cart__list">
              <li className="cart__item">
                <div className="cart__product-name">Гербіцид Комманд®, ФМС УКРАЇНА</div>
                <div className="cart__product__img-price__wrapper">
                  <div className="product__img__wrapper"><img src="https://agro-market.net/upload/resize_cache/iblock/cb9/240_340_1/vyic0xuomd7r6opt7y48g9bbg539yhq3.jpeg" alt="" /></div>
                  <div className="product__price__wrapper">
                    <div className="product__price">277 грн</div>
                  ...
                  <div className="quantity__wrapper">
                    <div className="quantity__control__container">
                      ...
                      <div className="quantity__decriment"></div>
                      <div className="quantity__amount">2</div>
                      <div className="quantity__increment"></div>
                    </div>
                  </div>
                </div>
              </li>
            ...
            <div className="cart__buttons__wraper">
              <button className="store__return">
